...
ADD CONSTRAINT FK_A_PROMOCION
    ...
    REFERENCES A_PROMOCION (ID_PROMOCION) ON DELETE CASCADE
;
...
REFERENCES A_PROVEEDOR(NIT) ON DELETE CASCADE
;
...
REFERENCES A_SUCURSAL(NOMBRE,DIRECCION,CIUDAD) ON DELETE CASCADE
;
...
REFERENCES A_LOCAL_VENTAS(ID_LOCALVENTAS) ON DELETE CASCADE
;
...
REFERENCES A_ALMACENAMIENTO (ID_ALMACENAMIENTO) ON DELETE CASCADE
;
...
REFERENCES A_CLIENTE(CORREO) ON DELETE CASCADE
;
...
-- Creación referencia FK de A_FACTURA_PRODUCTO a A_FACTURA

ALTER TABLE A_FACTURA_PRODUCTO
ADD CONSTRAINT FK_FACTURA_FP
FOREIGN KEY (NUMERO_FACTURA)
REFERENCES A_FACTURA (NUMERO_FACTURA) ON DELETE CASCADE
;

-- Creación referencia FK de A_FACTURA_PRODUCTO a A_PRODUCTO
ALTER TABLE A_FACTURA_PRODUCTO
ADD CONSTRAINT FK_PRODUCTO_FP
FOREIGN KEY (CODIGO_DE_BARRAS)
REFERENCES A_PRODUCTO (CODIGO_DE_BARRAS) ON DELETE CASCADE
;

-- Creación restricciones de A_FACTURA_PRODUCTO
ALTER TABLE A_FACTURA_PRODUCTO
ADD CONSTRAINT PK_A_FACTURA_PRODUCTO
PRIMARY KEY (NUMERO_FACTURA, CODIGO_DE_BARRAS)
;
